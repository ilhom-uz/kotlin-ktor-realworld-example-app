...
generate and iterate on tests for your new feature.
...
| **Agent Fluency** | Effective use of  agent. Thoughtful critique of its output. Clear documentation of prompts and iteration. |
